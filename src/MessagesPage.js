        ...
        <div>
            ...
            <div className="message-page-container">
                <div className="message-page-main-area">
                    ...
                    {/* {console.log(selectedUserBasic,"selectedUserBasic")} */}
                        ...
                        <div>
                            ...
                            <MessageArea userName={selectedUserBasic && selectedUserBasic.name} pp={selectedUserBasic && selectedUserBasic.ppLink} >
                                {messagesState && messagesState.map((m,index)=>{
                                    // {console.log(m.senderId,selectedUserBasic._id)}
                                        if(selectedUserBasic._id!==m.senderId){
                                            return(<MessageElement  key={index}>{m.text}{console.log(m.text)}</MessageElement>)
                                        }else{
