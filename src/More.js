...
const More = ()=>{
    ...
    return(
      ...
      <div className="nav-items">
                ...
                <NavbarItem className="navbar-mobile-custom" name="Your Activity">
                ...
                <NavbarItem name="Switch Appearance">
                ...
                <Link to="/direct/inbox/"><div id="message"><div className="red-badge" style={{zIndex:"10"}}>N!</div><img src={message_icon} alt="logo"/>Report a Problem</div></Link>
                ...
                <NavbarItem name="Switch Accounts">
                    <path
